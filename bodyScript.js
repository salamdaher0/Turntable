...
var area_05={
    name:"LONGITUDINAL_FISSURE",
    color:13,
    filename:"select_05_00",
    content:""};
    
var area_06={
    name:"CEREBRAL_CORETX",
    color: 166,
...
function(){
    ...
    GetImage(imageNumber, folderNameSt, imageNameSt, fileTypeSt);
    GetImage(imageNumber, folderNameSt_a, imageNameSt_a, fileTypeSt_a);
    for (var i=0;i<brain.length;i++){
